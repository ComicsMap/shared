...
export class Migration20260517165210 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "users" ("uuid" uuid not null default gen_random_uuid(), "username" varchar(64) not null, "display_name" varchar(64) null, "email" varchar(320) not null, "password" varchar(255) null, "google_id" varchar(64) null, "avatar_url" varchar(2048) null, "created_at" timestamptz not null default now(), "updated_at" timestamptz not null default now(), "deleted_at" timestamptz null, constraint "users_pkey" primary key ("uuid"));`);
